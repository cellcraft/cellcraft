...
class PlayerCommand:
    ...
    def getDirection(self):
        return Vec3(-sin(radians(self.mc.yaw)) * cos(radians(self.mc.pitch)), -sin(radians(self.mc.pitch)),
                    cos(radians(self.mc.yaw)) * cos(radians(self.mc.pitch)))
...
class Minecraft:
    def __init__(self, connection=None, autoId=True):
        ...
        self.me = cone(pos=(self.x - 0.5, self.y, self.z - 0.5), axis=(1, 0, 0), radius=0.5, color=color.red,
                       visible=False)
